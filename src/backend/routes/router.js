...
router.route("/doctor-profile/:demail").get(logc.ensure,mainc.doctorprofile);
...
router.route("/adminhome").get(logc.adminen,adminc.adminhomeget);
router.route("/adminusers").get(logc.adminen,adminc.adminusersget);
router.route("/admindoctors").get(logc.adminen,adminc.admindoctorsget);
router.route("/adminhospitals").get(logc.adminen,adminc.adminhospitalsget);
router.route("/adminedit/:useremail").get(logc.adminen,adminc.adminusersprofileget);
router.route("/adminuserapp/:useremail").get(logc.adminen,adminc.adminusersappget);
router.route("/adminuserreport/:useremail").get(logc.adminen,adminc.adminuserreportsget);
router.route("/admindoctorsprofile/:doctorid").get(logc.adminen,adminc.docadminprofileget);
router.route("/admindoctorsapp/:doctorid").get(logc.adminen,adminc.docadminapp);
router.route("/adminhospedit/:hospitalid").get(logc.adminen,adminc.adminhospdetget);
router.route("/adminprofile/:userid").post(logc.adminen,upload.single('image'),adminc.adminprofiledetpost);
router.route("/admindocprofile/:doctorid").post(logc.adminen,upload.single('image'),adminc.docadmindetpost);
router.route("/admincancelapp/:schedule_id/:slot_id/:useremail").post(logc.adminen,adminc.deleteapp);
router.route("/hospdets/:hospitalid").post(logc.adminen,upload.single('image'),adminc.edithospital);
